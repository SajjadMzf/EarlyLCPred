...
class Parameters:
    def __init__(self, SELECTED_MODEL = 'VCNN', SELECTED_DATASET = 'HIGHD', UNBALANCED = False, ABLATION = False):
        ...
        if self.UNBALANCED:
            ...
            self.unblanaced_ext = ''
        self.TRAIN_DATASET_DIR = '../../Dataset/{}/NOEV_ImageDataset/'.format(self.SELECTED_DATASET)
        self.TEST_DATASET_DIR = '../../Dataset/{}/NOEV_ImageDataset{}/'.format(self.SELECTED_DATASET, self.unblanaced_ext)
        ...
        def SELECTED_DATASET(self, val):
            ...
            self.DATASET_DIR = '../../Dataset/{}/NOEV_ImageDataset{}/'.format(self._SELECTED_DATASET, self.unblanaced_ext)
